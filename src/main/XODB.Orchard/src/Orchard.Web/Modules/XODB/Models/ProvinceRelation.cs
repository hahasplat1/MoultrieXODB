...
namespace XODB.Models
{
    ...
    public partial class ProvinceRelation
    {
        public System.Guid ProvinceRelationID { get; set; }
        public Nullable<System.Guid> OriginalProvinceID { get; set; }
        public Nullable<System.Guid> RelatedProvinceID { get; set; }
        ...
        public virtual Province X_Province { get; set; }
        public virtual Province X_Province1 { get; set; }
    }
}
