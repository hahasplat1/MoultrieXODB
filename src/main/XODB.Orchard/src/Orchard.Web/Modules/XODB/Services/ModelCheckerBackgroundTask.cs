...
namespace XODB.Services {
    ...
    {
        public const string NEXT_UPDATE_CACHE_KEY = "XODB.ModelCheckerBackgroundTask.NextUpdate.Changed";
        public const string MODEL_FILES_HASH_CACHE_KEY = "XODB.ModelCheckerBackgroundTask.ModelFiles.Changed";
