...
namespace XODB.Module.BusinessObjects.XODB
{
    ...
    [Persistent(@"X_ContractConditionModel")]
    public partial class ContractConditionModel : XPLiteObject
    {
        Guid fContractConditionModelID;
        [Key(true)]
        public Guid ContractConditionModelID
        {
            get { return fContractConditionModelID; }
        ...
        [Association(@"ContractConditionModelReferencesX_DictionaryModel")]
